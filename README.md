...
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:7ec89a,40:f48fb1,60:f48fb1,100:7ec89a&height=2&width=55%25" alt="divider" />
...
This repository was developed as the product and service implementation phase of the capstone project.

| Phase | Period | Description |
|---|---|---|
| Service Architecture Setup | 2026.03 | Initial monorepo structure, Docker Compose environment, Spring Boot backend, FastAPI AI service, PostgreSQL, and React/Vite frontend setup |
| Core Service Implementation | 2026.04 | Chest X-ray upload flow, analysis lifecycle, backend-to-AI service integration, result data structure, and local service pipeline implementation |
| Demo Finalization & Documentation | 2026.05 | Web demo screen refinement, Grad-CAM result presentation, repository documentation, academic output organization, and final presentation readiness |
...
The conference paper cover and award certificate are stored as repository assets.
...
<details>
<summary><b>View Award Certificate Preview</b></summary>
